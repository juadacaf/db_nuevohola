...
class usuario{
    public static function registrarUsuario($documento,$nombre,$fecha, $clave){
        $conexion = mysqli_connect('localhost','root','','db_nuevohola');
        $salida = 0;
    ...
    public static function actualizarDato($documento,$nombre,$fecha, $clave){
        $conexion = mysqli_connect('localhost','root','','db_nuevohola');
        $salida = 0; 
        $sql ="UPDATE tb_usuarios
               SET nombre = '$nombre', contraseña= '$clave', fecha_nac= '$fecha'
